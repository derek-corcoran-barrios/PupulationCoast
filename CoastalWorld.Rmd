...
InnerArea <- terra::expanse(World_Inner, unit = "km")
WorldArea <- terra::expanse(World, unit = "km")
```
...
The Inner area is `r prettyNum(InnerArea, big.mark = ",")`, that is  r (terra::expanse(World_Inner, unit = "km")/terra::expanse(World, unit = "km"))*100, 2) percent of the workd
